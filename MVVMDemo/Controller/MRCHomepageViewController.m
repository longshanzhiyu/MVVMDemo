...
//        newsViewController.tabBarItem = [[UITabBarItem alloc] initWithTitle:@"News" image:newsImage selectedImage:newsHLImage];
        MRCViewController *newsViewController = [[MRCViewController alloc] init];
        newsViewController.view.backgroundColor = [UIColor orangeColor];
...
//        reposViewController.tabBarItem = [[UITabBarItem alloc] initWithTitle:@"Repositories" image:reposImage selectedImage:reposHLImage];
        MRCViewController *reposViewController = [[MRCViewController alloc] init];
        reposViewController.view.backgroundColor = [UIColor greenColor];
        reposViewController.title = @"repos";
...
//        exploreViewController.tabBarItem = [[UITabBarItem alloc] initWithTitle:@"Explore" image:exploreImage selectedImage:exploreHLImage];
        MRCViewController *exploreViewController = [[MRCViewController alloc] init];
        exploreViewController.view.backgroundColor = [UIColor brownColor];
...
//        profileViewController.tabBarItem = [[UITabBarItem alloc] initWithTitle:@"Profile" image:profileImage selectedImage:profileHLImage];
        ...
        MRCViewController *profileViewController = [[MRCViewController alloc] init];
